...
import { getAllPersons, Person } from "@/lib/persons";
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        {loading ? (
              ...
              <Card key={index} className="overflow-hidden border-slate-200">
                <CardContent className="p-6 sm:p-8">
                  <div className="flex flex-col items-center text-center space-y-4 sm:space-y-6">
                    <Skeleton className="h-28 w-28 sm:h-32 sm:w-32 md:h-36 md:w-36 rounded-full" />
          ...
          <div className="text-center py-16">
            <p className="text-xl text-slate-600">لا توجد صدقات جارية حالياً</p>
            <p className="text-sm text-slate-500 mt-2">يمكنك إضافة صدقة جارية من لوحة التحكم</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
